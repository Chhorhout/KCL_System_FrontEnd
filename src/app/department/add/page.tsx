...
const DRAFT_KEY = 'add-department-draft-v1';
...
export default function AddDepartment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      throw new Error(lastError || 'Failed to create department');
    } catch (err: any) {
      setError(err?.message || "Failed to add department");
      Swal.fire({
        title: 'Error',
        text: err?.message || 'Failed to add department',
        icon: 'error',
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-8 py-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-3xl font-bold text-white">Add New Department</h2>
          </div>
          <p className="text-blue-100 text-sm mt-1">Create a new department for your organization</p>
        </div>
        ...
        >
          ...
          {success && (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-700 text-sm font-medium">Department added successfully!</span>
              </div>
            </motion.div>
          )}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-bold rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center gap-2 disabled:transform-none"
